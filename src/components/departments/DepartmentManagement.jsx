...
const DepartmentManagement = ({ departments, addDepartment, callNextTicket, currentUser }) => {
        ...
        <AnimatePresence>
          {departmentsToManage.map((dept, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-4 text-slate-800">{dept.name}</h3>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-slate-700">{dept.averageTime} min</span>
                </div>
              </div>
