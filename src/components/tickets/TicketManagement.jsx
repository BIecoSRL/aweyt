...
const TicketManagement = ({ tickets, departments, services, completeTicket, redirectTicket, cancelTicket, callTicket, serveTicket, currentUser }) => {
  ...
  const relevantServices = useMemo(() => {
    ...
    return services.filter(s => s.departmentId === parseInt(redirectData.departmentId));
  }, [redirectData.departmentId, services]);
  ...
  const activeTickets = useMemo(() => {
    return tickets.filter(t => {
      ...
      return (t.departmentId === currentUser.departmentId && ['waiting', 'called'].includes(t.status)) || (t.servedBy === currentUser.id && t.status === 'serving');
